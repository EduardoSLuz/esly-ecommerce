<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="list-group">
	...
	<a class="list-group-item list-group-item-action py-4 font-weight-light">
		...
		<span class="text-second-site-section"><br> <?php echo utf8_encode(ucwords(strftime('%A, %d', strtotime('today')))); ?> de <?php echo ucfirst(strftime('%B', strtotime('today'))); ?> de <?php echo ucfirst(strftime('%Y', strtotime('today'))); ?> às <?php echo date('H:i'); ?></span>
	</a>
