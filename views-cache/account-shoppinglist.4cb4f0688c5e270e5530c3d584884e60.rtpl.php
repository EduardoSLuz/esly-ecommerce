						...
						<table class="table table-sm table-hover">
							<thead>
							  <tr>
								...
								<th class="font-weight-normal">Lista</th>
								<th class="font-weight-normal">Criada em</th>
								<th class="font-weight-normal">Remover</th>
							  </tr>
							</thead>
							<tbody>
								  <tr class="cursorPointer">
									<th scope="row" onclick="window.location.assign('/loja-<?php echo htmlspecialchars( $links["idStore"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/account/shopping-list/1/')"><span class="text-decoration-none text-dark">1</span></th>
									<td onclick="window.location.assign('/loja-<?php echo htmlspecialchars( $links["idStore"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/account/shopping-list/1/')"><span class="text-decoration-none text-dark">NumberOne</span></td>
									<td onclick="window.location.assign('/loja-<?php echo htmlspecialchars( $links["idStore"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/account/shopping-list/1/')"><span class="text-decoration-none text-dark">09/07/2020 16:20</span></td>
									<td>
