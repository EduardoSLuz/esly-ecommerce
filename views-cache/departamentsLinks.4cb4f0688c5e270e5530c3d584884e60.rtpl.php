<?php if(!class_exists('Rain\Tpl')){exit;}?><?php if( isset($storeInstitution["0"]["hdInfo1"]) && $storeInstitution["0"]["hdInfo1"] == 1 ){ ?>
<p class="h6 text-second-site-section">Relacionados</p>
<hr>
