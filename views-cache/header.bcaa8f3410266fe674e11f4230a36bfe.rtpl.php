...
<head>
  ...
  <title><?php echo strstr($stores["0"]["nameStore"], " ", true); ?> | Painel</title>
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
	<link rel="icon" type="image" href="<?php echo htmlspecialchars( $imgs["6"]["src"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item d-flex align-items-center">
        ...
        <?php if( $value1["statusStore"] == 1 ){ ?><?php $ctStores = $ctStores + 1; ?><?php } ?>
        ...
        <audio id="audioNotification" src="/resources/audio/success.mp3" data-status="0"></audio>
        
        <select name="selectStAdmin" id="selectStAdmin" class="btn btn-link text-dark">
          <?php if( isset($stores) && $ctStores >= 1 ){ ?>
          ...
          <?php if( $value1["statusStore"] == 1 ){ ?><option value="<?php echo htmlspecialchars( $value1["idStore"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Loja <?php echo htmlspecialchars( $value1["store"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option><?php } ?>
          ...
          <?php if( isset($stores) && $ctStores == 0 ){ ?>

          <option value="0" selected>Sem Lojas</option>
          <?php } ?>

        </select>

        <script> 
          document.getElementById("selectStAdmin").value = "<?php echo htmlspecialchars( $st, ENT_COMPAT, 'UTF-8', FALSE ); ?>"
        </script>
      ...
      <li class="nav-item dropdown">
        ...
        <div id="notificationsStores" class="dropdown-menu dropdown-menu-lg dropdown-menu-right" data-play="<?php echo htmlspecialchars( $notifications["play"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" data-href="<?php echo htmlspecialchars( $notifications["href"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
          ...
          <span class="dropdown-item dropdown-header" title="Próxima Atualização da Lista de Produtos">
            <a class="cursor-pointer">
              <?php if( isset($storeUpdate["0"]["dateList"]) && isset($storeUpdate["0"]["time"]) && isset($storeUpdate["0"]["status"]) &&$storeUpdate["0"]["status"] == 1 ){ ?><i class="fas fa-sync-alt"></i> <?php echo date("H:i d/m/Y", strtotime('+'.$storeUpdate["0"]["time"].' hours', strtotime($storeUpdate["0"]["dateList"]))); ?><?php }else{ ?><?php } ?></a>
          </span>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/loja-<?php echo htmlspecialchars( $stores["0"]["store"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/account/data/" class="d-block"><?php echo htmlspecialchars( $userValues["nameUser"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/admin/orders-horary/" class="nav-link">
