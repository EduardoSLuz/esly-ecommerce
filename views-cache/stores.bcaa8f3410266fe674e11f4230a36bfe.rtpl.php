                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="h5">
                            ...
                            <a class="mx-1" href="#" data-toggle="modal" data-target="#modalCartConfig" data-id='<?php if( isset($value1["cartConfig"]["idCartConfig"]) ){ ?><?php echo htmlspecialchars( $value1["cartConfig"]["idCartConfig"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php }else{ ?>0<?php } ?>' data-store="<?php echo htmlspecialchars( $value1["store"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" data-allow='<?php if( isset($value1["cartConfig"]["allowMin"]) ){ ?><?php echo htmlspecialchars( $value1["cartConfig"]["allowMin"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php }else{ ?>0<?php } ?>' data-val-min='<?php if( isset($value1["cartConfig"]["valueMin"]) ){ ?><?php echo htmlspecialchars( $value1["cartConfig"]["valueMin"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php }else{ ?>0<?php } ?>'><i class="fas fa-shopping-cart"></i></a>
