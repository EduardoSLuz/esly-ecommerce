		...
		<div class="ct-ini mt-mobNavbar">
			...
			<nav aria-label="breadcrumb" class="bar-display">
				<ol class="breadcrumb bg-site-section">
				  ...
				  <li class="breadcrumb-item text-link-site-section" aria-current="page">Peguntas Frequentes</li>
				</ol>
			</nav>
			...
			<div class="row">
				...
				<div class="col-md">
					...
					<p class="h5 text-uppercase font-weight-normal text-second-site-section">Perguntas Frequentes</p>
					<hr>
					...
					<div class="accordion" id="AccordinOne">
						...
						<div class="card btn btn-light border mt-2" data-toggle="collapse" data-target="#collapse<?php echo htmlspecialchars( $value1["idStoreHelp"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-expanded="true" aria-controls="collapse">
							...
							<a class="py-2 h6 text-left text-second-site-section"><?php echo htmlspecialchars( $value1["titleHelpStore"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>						  
						...
						<div id="collapse<?php echo htmlspecialchars( $value1["idStoreHelp"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="collapse bg-white border" aria-labelledby="headingOne" data-parent="#AccordinOne">
							...
							<div class="card-body">
								<p class="text-second-site-section"><?php echo htmlspecialchars( $value1["textHelpStore"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
							</div>
