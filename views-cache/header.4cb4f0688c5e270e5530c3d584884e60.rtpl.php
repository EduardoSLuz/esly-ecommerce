...
<html lang="pt-br">
  ...
  <body class="bg-site-section">
	...
	<div id="overlayBody" class="d-flex justify-content-center align-items-center">
	...
	<section id="Navbar-Desktop" class="bg-site-header sticky-top-esly zIndexPanels" >
		...
		<div class="navbar-prime">
			...
			<div class="ct-center">
				...
				<nav class="navbar navbar-expand-lg row">
					...
					<a class="col-lg-2 col-md-4 col-4 text-center" href="/loja-<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>/">
						<picture>
							<source data-srcset="<?php echo htmlspecialchars( $imgs["5"]["src"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" media="(max-width: 600px)">
							<img src="/resources/imgs/logos/loading.gif" data-src="<?php echo htmlspecialchars( $imgs["2"]["src"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="lazyload d-inline-block align-top img-fluid logo-responsive" alt="Logo Loja-<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
						</picture>
					</a>
											...
											<div class="table-ini">
												...
												<div class="border-bottom text-second-site-section py-2">
													...
													<small><br>
														...
														<?php } ?>
														X R$ <?php echo maskPrice($value1["priceItem"]); ?>
													</small>
												</div>
												<?php } ?>
		...
		<!-- 
			<div id="alertBoxCartNot" class="position-fixed my-lg-0 my-2 offset-lg-9 col-lg-3 offset-md-8 col-md-4 zIndexPanels">

			<div id="alertCartNot" class="alert alert-success fade show text-center my-0" role="alert">
		...
		<div id="alertCartNot" class="position-fixed my-lg-0 my-2 offset-lg-8 col-lg-4 offset-xl-9 col-xl-3 offset-md-7 col-md-5 zIndexPanels d-none">
			<div class='alert alert-success fade show text-center my-0 border-0' role="alert">
	...
	<section id="BarMobile" class="bg-site-section collapse display-None">
		...
		<div id="DepartamentosMobile" class="navbar-displayNone">
			...
			<a class="btn border border-left-0 border-right-0 w-100 bd-RdNull py-SubMobile text-left" href="/loja-<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>/departaments/">
				<b class="font-weight-normal mx-2 tx-SubMobile text-second-site-section"><i>DEPARTAMENTOS:</i></b>
			</a>
			...
			<div class="btn-group w-100">
				...
				<?php if( isset($storeInstitution["0"]["hdInfo1"]) && $storeInstitution["0"]["hdInfo1"] == 1 ){ ?>
							...
							<a class="text-main-site-header nav-item align-top h4" href="/loja-<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>/departaments" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<li class="nav-item text-dep-site-header dropdown">
									<a class="dropdown-item text-decoration-none border d-flex" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="window.location.assign('/loja-<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>/departaments/<?php echo htmlspecialchars( $value1["name"], ENT_COMPAT, 'UTF-8', FALSE ); ?>-0/')">
										<span class="flex-grow-1 pr-2"><?php echo htmlspecialchars( $value1["name"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span> 
										<?php if( isset($storeInstitution["0"]["hdInfo1"]) && $storeInstitution["0"]["hdInfo1"] == 1 ){ ?>
										<span class="pl-2"><i class="fas fa-angle-right"></i></span>
										<?php } ?>
									</a>
