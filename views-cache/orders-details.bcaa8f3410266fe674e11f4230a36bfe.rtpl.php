              ...
              <div class="invoice p-3 mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 my-2 no-print">
                    ...
                    <button type="button" target="_blank" class="btn btn-sm btn-default float-right" onclick="window.print();"><i class="fas fa-print"></i> </button>
                  ...
                  <div class="col-12 table-responsive">
                    <table id="tbOrderItem" class="table table-striped">
                      ...
                      <tr>
                        ...
                        <td><?php echo htmlspecialchars( $value1["descProduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
