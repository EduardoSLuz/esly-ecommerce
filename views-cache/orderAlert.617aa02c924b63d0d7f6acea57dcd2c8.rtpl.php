              ...
              <table cellspacing="0">
                <tr>
                  <td>
                    <table class="soapbox">
                      <tr>
                        <td class="soapbox-title"><?php echo htmlspecialchars( $title, ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                      </tr>
                    </table>
                    <table class="body">
                      <tr>
                        ...
                        <td class="body-padded">
                            ...
                            <tr>
                              <td class="body-text-cell">
                                ...
                                <p style="text-align: justify;">
                                  <?php echo htmlspecialchars( $text, ENT_COMPAT, 'UTF-8', FALSE ); ?>

                                </p>

                                <p style="text-align: center;">
                                  <?php if( isset($store["telephoneStore"]) && !empty($store["telephoneStore"]) ){ ?>

                                  <span><b>Telefone:</b> <i><?php echo maskTel($store["telephoneStore"]); ?></i> </span>
                                  <?php } ?>


                                  <?php if( isset($store["telephoneStore"]) && !empty($store["telephoneStore"]) && isset($store["whatsappStore"]) && !empty($store["whatsappStore"]) ){ ?>|<?php } ?>


                                  <?php if( isset($store["whatsappStore"]) && !empty($store["whatsappStore"]) ){ ?>

                                  <span><b>Whatsapp:</b> <i><?php echo maskTel($store["whatsappStore"]); ?></i> </span>
                                  <?php } ?>
                          ...
                          <div>
                            <a style="cursor: pointer;padding: 10px;border-radius: 10px;background-color: #32a1ce;border-color: #32a1ce;color: white;" href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i>Acessar</i></a></div>
