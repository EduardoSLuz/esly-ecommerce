		...
		<div class="ct-ini mt-mobNavbar">
			...
			<div id="BarLogin" class="text-center">
				...
				<form id="formLoginRegister" class="formLoginRegister offset-md-3 col-md-6 py-3" method="POST" data-store="<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
					...
					<div id="alertsLoginRegister" class="alert alert-success alert-dismissible fade d-none text-left" role="alert">
					...
					<div class="my-2">
						...
						<div id="overlayLoginRegister" class="btn d-none">
							<div class="overlay d-flex justify-content-center align-items-center">
								<i class="fas fa-1x fa-sync fa-spin"></i>
							</div>
						</div>
	
						<button type="submit" class="btn btn-main-site-section text-btn-site-section" tabindex="4">Cadastrar</button>
