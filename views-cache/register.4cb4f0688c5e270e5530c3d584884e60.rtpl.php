			...
			<div id="BarLogin" class="text-center">
				...
				<form class="offset-md-3 col-md-6 py-3" method="POST">
					...
					<div class="input-group text-center mt-4 border border-secondary rounded">
						...
						<input type="email" name="emailUser" class="form-control null-bd border-left-0 rounded-right" placeholder="E-mail" aria-describedby="Email User" value="<?php echo htmlspecialchars( $registerValues["emailUser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" tabindex="1" autofocus>
					...
					<div class="input-group text-center mt-3 border border-secondary rounded">
						...
						<div class="input-group-prepend">
						  <button type="button" id="BtnLockRepeat" class="input-group-text null-bd bg-white" onclick="AlterTypeInput('passRepeatUser', 'BtnLockRepeat', 'fas fa-lock', 'fas fa-unlock')"><i id="IconePass" class="fas fa-lock"></i></button>
						</div>
