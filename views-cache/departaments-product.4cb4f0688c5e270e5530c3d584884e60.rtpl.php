				...
				<div class="row">
					...
					<div class="col-md-8">
						<p class="font-weight-normal h4 text-second-site-section">
							<?php if( $dep["cat"] != '' && $dep["cat"] !== 0 ){ ?> <?php echo htmlspecialchars( $dep["cat"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <?php }else{ ?> <?php echo htmlspecialchars( $dep["name"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <?php } ?>
						</p>
					</div>
							...
							<?php $nameCard = $value1["codProduct"]."$key1"; ?>
							  	...
							  	<div class="card-body text-center">
								  	...
								  	<p class="btn-group btn-group-toggle m-0" data-toggle="buttons">
										...
										<?php $unitsMeasures = $value1["unitsMeasures"]["0"]; ?>
								...
								<form id="formCard<?php echo htmlspecialchars( $value1["codProduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php echo htmlspecialchars( $key1, ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="formEnvia" data-id="<?php echo htmlspecialchars( $value1["codProduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" data-store="<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>" data-type="0">
								  	...
								  	<div class="btn-group btn-group-justified w-100">
										...
										<input id="inputCardDiversos<?php echo htmlspecialchars( $value1["codProduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php echo htmlspecialchars( $key1, ENT_COMPAT, 'UTF-8', FALSE ); ?>" name="inputCardDiversos" type='<?php if( isset($value1["unitsMeasures"]["0"]["freeFill"]) && $value1["unitsMeasures"]["0"]["freeFill"] == 1 ){ ?>text<?php }else{ ?>number<?php } ?>' class="inputQtdCart text-center maskMoney2" value="1" max="<?php echo htmlspecialchars( $value1["stock"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="font-size: 11px;font-weight: bold;width: 35%;" <?php if( isset($value1["unitsMeasures"]["0"]["freeFill"]) && $value1["unitsMeasures"]["0"]["freeFill"] == 0 ){ ?>readonly="true"<?php } ?>>
