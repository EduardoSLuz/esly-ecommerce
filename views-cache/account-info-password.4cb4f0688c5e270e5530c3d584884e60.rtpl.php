<?php if(!class_exists('Rain\Tpl')){exit;}?>	<section class="ct-center">
		...
		<div class="ct-ini mt-mobNavbar">
			...
			<nav aria-label="breadcrumb" class="bar-display">
				<ol class="breadcrumb <?php echo htmlspecialchars( $layout["bgLayout"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
					<li class="breadcrumb-item"><a href="/loja-<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>/">Home</a></li>
				 	...
				 	<li class="breadcrumb-item"><a href="/loja-<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>/account/data/">My Info</a></li>
			...
			<div class="row">
				...
				<div class="col-md">
					<p class="h4 font-weight-normal">Alterar minha senha</p>
					...
					<form method="POST">
						...
						<div class="my-3">
							<label for="PassInfo">Senha Atual:</label>
							<div class="input-group">
								<div class="input-group-prepend border">
									<button type="button" id="BtnLock" class="input-group-text null-bd bg-white" onclick="AlterTypeInput('PassInfo', 'BtnLock', 'fas fa-lock', 'fas fa-unlock')"><i id="IconePass" class="fas fa-lock"></i></button>
								</div>
