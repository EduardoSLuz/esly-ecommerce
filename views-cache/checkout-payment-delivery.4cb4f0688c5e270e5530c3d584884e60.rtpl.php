			...
			<div class="row">
				...
				<div class="col-md-9">
							...
							<div class="tab-pane fade show active" id="OptionFisic" role="tabpanel" aria-labelledby="OptionFisic-tab">
								...
								<div class="btn-group-toggle px-4 py-3" data-toggle="buttons">
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicOne')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicTwo')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicThree')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicFour')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicFive')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicSix')" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="false">
											<input type="checkbox">
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2"  onclick="ExecuteClick('IptPayFisicSeven')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="btn btn-outline-dark IptsPayFisic" onclick="SelectBtnRadios('PayFisicEight', 'PaysFisic', 'IptsPayFisic', 'font-weight-bold')">
											<input id="IptPayFisicEight" type="radio">
										</label>
			
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicEight')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
											
											<p class="my-0">

												<a data-toggle="popover" data-placement="top" data-trigger="hover" title="Aviso" data-html="true" data-content="<p>
													Depositar somente após receber a confirmação de separação dos itens pela nossa equipe:<br>
													<br>
													Conta para depósito:<br>
													<br>
													Agência: 0000<br>
													Conta corrente: 00000-0<br>
													Titular: Nome da loja<br>
													CNPJ: 00.000.000/0000-00<br>
													Banco: 000
												</p>"><i class="fas fa-info-circle"></i></a>

												<img src="/resources/imgs/cards-payment/deposito_bancario.png" alt="Deposito_Bancario" >

												<span id="PayFisicEight" class="PaysFisic">Depósito Bancário</span>
											</p>
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="btn btn-outline-dark IptsPayFisic" onclick="SelectBtnRadios('PayFisicNine', 'PaysFisic', 'IptsPayFisic', 'font-weight-bold')">
											<input id="IptPayFisicNine" type="radio">
										</label>
			
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicNine')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
											
											<p class="my-0">

												<img src="/resources/imgs/cards-payment/vale.png" alt="Vale" >

												<span id="PayFisicNine" class="PaysFisic">Vale</span>
											</p>
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="btn btn-outline-dark IptsPayFisic" onclick="SelectBtnRadios('PayFisicTen', 'PaysFisic', 'IptsPayFisic', 'font-weight-bold')">
											<input id="IptPayFisicTen" type="radio">
										</label>
			
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicTen')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
											
											<p class="my-0">
												<img src="/resources/imgs/cards-payment/hiper.png" alt="Hiper" >

												<span id="PayFisicTen" class="PaysFisic">Hiper</span>
											</p>
									...
									<div class="my-1 btn-group width-T100">
										...
										<label class="btn btn-outline-dark IptsPayFisic" onclick="SelectBtnRadios('PayFisicEleven', 'PaysFisic', 'IptsPayFisic', 'font-weight-bold')">
											<input id="IptPayFisicEleven" type="radio">
										</label>
			
										<label class="border border-left-0 shadow-none btn text-left width-T100 py-2" onclick="ExecuteClick('IptPayFisicEleven')" data-toggle="pill" href="#BarEmpty" role="tab" aria-controls="BarEmpty" aria-selected="false">
											<input type="checkbox">
											
											<p class="my-0">
												<img src="/resources/imgs/cards-payment/american_express.png" alt="American_Express" >

												<span id="PayFisicEleven" class="PaysFisic">American Express</span>
											</p>
									...
									<div class="tab-content" id="pills-tabContent">
										<div class="tab-pane fade mt-2" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
											
											<label for="InputChange" class="font-weight-bold">Caso precise de troco, informe o valor abaixo:</label>
											<input id="InputChange" class="form-control" placeholder="R$ 00,00">
											
										</div>

										<div class="tab-pane fade" id="BarEmpty" role="tabpanel" aria-labelledby="BarEmpty"></div>
									</div>
								</div>
					...
					<div class="row my-4">
						...
						<div class="col-6">
							<a href="/loja-<?php echo htmlspecialchars( $links["idStore"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/checkout/horary/" class="btn btn-sm btn-light border border-black"><i class="fas fa-arrow-left"></i> <b class="d-mobile font-weight-normal">Voltar a Horário da Entrega</b></a>
						</div>
