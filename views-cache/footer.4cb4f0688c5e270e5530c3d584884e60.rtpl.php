<?php if(!class_exists('Rain\Tpl')){exit;}?><footer id="Footer-RedesSociais" class="bg-primary mt-5">
		
    <div class="bcg-ini ct-center">
        
        <div class="text-right text-light py-2">
            <a class="font-weight-normal">Redes Sociais:</a>
            <a href="https://www.instagram.com/" target="__blank" class="text-light h5"><i class="fab fa-instagram"></i></a>&nbsp;   
        ...
        <div class="col-md-4 mt-mob">
            ...
            <p>
                <form class="input-group mb-2" method="POST">
                    ...
                    <button type="button" class="btn btn-primary input-group-append">Enviar</button>
