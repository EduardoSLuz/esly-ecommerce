                            ...
                            <ul class="txList-StyleNone tx-IconCart">
                                ...
                                <?php $counter1=-1;  if( isset($horary) && ( is_array($horary) || $horary instanceof Traversable ) && sizeof($horary) ) foreach( $horary as $key1 => $value1 ){ $counter1++; ?>
                                    <li class="my-2 text-site-footer-main">
                                        ...
                                        <?php echo htmlspecialchars( $value1["name"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php if( isset($value1["dayNameFinal"]) ){ ?> - <?php echo htmlspecialchars( $value1["dayNameFinal"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>:
                    ...
                    <?php if( isset($storePayment) && $storePayment != 0 ){ ?>
                        ...
                        <div class="my-2">
                            ...
                            <?php $counter2=-1;  if( isset($value1["types"]) && ( is_array($value1["types"]) || $value1["types"] instanceof Traversable ) && sizeof($value1["types"]) ) foreach( $value1["types"] as $key2 => $value2 ){ $counter2++; ?>
                                <img src="/resources/imgs/logos/loading.gif" data-src="<?php echo htmlspecialchars( $value2["src"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="<?php echo htmlspecialchars( $value2["pay"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="lazyload d-block-inline img-fluid mr-2" data-toggle="popover" data-placement="top" data-trigger="hover" data-html="true" data-content="<?php echo htmlspecialchars( $value2["pay"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="max-height: 35px;">
                            <?php } ?>
                ...
                <div class="col-md-4 mt-mob">
                    ...
                    <p>
                        ...
                        <div class="row">
                            ...
                            <img src="/resources/imgs/logos/loading.gif" data-src="/resources/imgs/cards-security/google_security.png" alt="Google_Security" class="lazyload ml-3" data-toggle="popover" data-placement="top" data-trigger="hover" data-html="true" data-content="Google" width="150" height="50">
                            
                            <img src="/resources/imgs/logos/loading.gif" data-src="/resources/imgs/cards-security/Certising.png" alt="Certising" class="lazyload ml-3" data-toggle="popover" data-placement="top" data-trigger="hover" data-html="true" data-content="Certising" width="100" height="50">
...
<?php if( $wp === true ){ ?>        
<div id="BtnWhatsapp" class="BtnsFloat ml-3 mb-5 text-left fixed-bottom null-height zIndexPanels">
...
<?php if( $ct === true ){ ?>
<div id="BtnCart" class="BtnsFloat mr-3 mb-5 text-right fixed-bottom null-height cart-BtnFloat zIndexPanels">
...
<?php if( $ft === true ){ ?>
<div id="BtnFilter" class="BtnsFloat text-left fixed-bottom null-height cart-BtnFloat top-25 zIndexPanels">
