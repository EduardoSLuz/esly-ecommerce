		...
		<div class="ct-ini mt-mobNavbar">
			...
			<div id="BarLogin" class="text-center row">
				...
				<form id="formLogin" class="formLogin offset-md-2 col-md-4 py-4" method="POST" data-store="<?php echo htmlspecialchars( $ID, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
					...
					<p class="h2 font-weight-normal px-3 text-second-site-section">Seja Bem-vindo ao Ecommerce!</p>
	
					<p class="tx-IconCart mt-3 text-second-site-section">Para adicionar itens ao carrinho é preciso entrar em sua conta.</p>

					<p class="h3 font-weight-normal text-second-site-section">Se já estiver cadastrado</p>
				...
				<div class="col-md-4 border border-primary bg-site-header rounded py-4 mx-2">
					...
					<div class="text-center">
						<img src="<?php echo htmlspecialchars( $imgs["3"]["src"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="py-5 img-fluid mx-auto bar-display" style="max-height: 375px;">
					</div>
