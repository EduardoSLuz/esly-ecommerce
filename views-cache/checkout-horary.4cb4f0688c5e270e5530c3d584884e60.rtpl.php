		...
		<div class="ct-ini mt-mobNavbar">
			...
			<nav aria-label="breadcrumb" class="bar-display">
				<ol class="breadcrumb bg-white px-0">
				  ...
				  <li class="breadcrumb-item"><a href="#">Loja 01</a></li>
			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="h4 font-weight-normal">Horário de Retirada</p>
					...
					<p class="h5 my-4 font-weight-normal">Selecione um horário de retirada abaixo:</p>
									...
									<tr class="text-truncate">
										...
										<td class="text-center tx-IconCart py-3">
											...
											<div class="cursorPointer border px-4 py-1 IptsTable " data-id="13" onclick="SelectIptTable('13', 'IptsTable', 'border-dark', 'selected')">
												...
												<a>08:00 até 12:00</a>
												<a class="text-success"><br>R$ 0,00</a>
					...
					<div class="row my-4">
						...
						<div class="col-6">
							<a href="/loja-<?php echo htmlspecialchars( $links["idStore"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/checkout/delivery-pickup/" class="btn btn-sm btn-light border border-black"><i class="fas fa-arrow-left"></i> <b class="d-mobile font-weight-normal">Voltar a Entregar/Retirar</b></a>
						</div>
