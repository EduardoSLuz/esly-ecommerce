<?php if(!class_exists('Rain\Tpl')){exit;}?>	<section class="ct-center">
		...
		<div class="ct-ini mt-mobNavbar">
			...
			<div class="row">
				...
				<div class="col-md">
					<p class="h4 py-3 text-uppercase font-weight-normal">Não existem pedidos na sua conta.</p>
					
					<a href="/loja-<?php echo htmlspecialchars( $links["idStore"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/" class="btn btn-primary btn-sm">Ir as compras</a>
				</div>
